function downloadUNSC() {
   ...
   var fileURL =  "/storage/sdcard0/CAMUN/UNSC.pdf";
...
function downloadHSC() {
   ...
   var fileURL =  "/storage/sdcard0/CAMUN/HSC.pdf";
...
function downloadSPECPOL() {
   ...
   var fileURL =  "/storage/sdcard0/CAMUN/SPECPOL.pdf";
...
function downloadUNODC() {
   ...
   var fileURL =  "/storage/sdcard0/CAMUN/UNODC.pdf";
...
function downloadECOSOC() {
   ...
   var fileURL =  "/storage/sdcard0/CAMUN/ECOSOC.pdf";
...
function downloadUNSDG() {
   ...
   var fileTransfer = new FileTransfer();
   var uri = encodeURI("https://drive.google.com/uc?export=download&id=ID_HERE");
   var fileURL =  "/storage/sdcard0/CAMUN/UNSDG.pdf";
