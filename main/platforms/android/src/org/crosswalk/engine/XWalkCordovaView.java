...
public class XWalkCordovaView extends XWalkView implements CordovaWebViewEngine.EngineView {
    ...
    private static Context setGlobalPrefs(Context context, CordovaPreferences preferences) {
        if (!hasSetStaticPref) {
            ...
            boolean prefAnimatable = preferences != null && preferences.getBoolean("CrosswalkAnimatable", false);
            boolean manifestAnimatable = ai.metaData != null && ai.metaData.getBoolean("CrosswalkAnimatable");
